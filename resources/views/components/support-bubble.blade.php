...
<div class="spatie-support-bubble | text-sm fixed {{$position}} z-10 flex-col m-4 gap-3" style="max-width: 340px; display: none;">
    <div class="spatie-support-bubble__container | bg-white shadow-xl border border-gray-300 rounded p-6" style="display: none">
